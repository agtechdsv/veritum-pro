export const en = {
    ...
    management: {
        features: {
            cognitio_dashboards: 'Analytical Dashboards',
            cognitio_magistrados: 'Magistrate Profile',
            cognitio_preditiva: 'Predictive Analysis (AI)',
            intelligence_golden_alerts: 'Golden Alerts',
            intelligence_matcher: 'Semantic Matcher',
            nexus_controle_societario: 'Corporate Control',
            nexus_gestao_ativos: 'Asset Management',
            nexus_gestao_equipe: 'Team and Workspace Management',
            nexus_gestao_pessoas: 'People Management (Basic CRM)',
            nexus_gestao_prazos: 'Case and Deadline Management',
            nexus_workflows: 'Advanced Workflows',
            scriptor_assinatura: 'Digital Signature',
            scriptor_auditoria_risco: 'Risk Audit (AI)',
            scriptor_ged: 'Document Repository (DMS)',
            scriptor_gerador_ia: 'Pleading Generator (AI)',
            sentinel_analise_sentimento: 'Sentiment Analysis (AI)',
            sentinel_captura_antecipada: 'Early Capture',
            sentinel_clipping_midia: 'Smart Clipping',
            sentinel_diarios: 'Official Gazettes Monitoring',
            valorem_boletos_pix: 'Boleto and PIX Issuance',
            valorem_financeiro: 'Financial Management',
            valorem_pjecalc: 'PJe-Calc Integration & Updates',
            valorem_provisionamento: 'Contingency Reports',
            vox_portal: 'Client Portal',
            vox_traducao_ia: 'Legal Jargon Translation (AI)',
            vox_whatsapp: 'WhatsApp Automation'
        },
        accessGroups: {
            title: 'Access Groups',
