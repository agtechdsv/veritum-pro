export const en = {
    ...
    modules: {
        ...
        nexus: {
            ...
            finance: {
                ...
                balance: 'Net Balance',
                roi: 'ROI (Return)',
                filtersTitle: 'Financial Filters',
                filtersSubtitle: 'Adjust period for performance analysis',
            ...
            modals: {
                lawsuit: {
                    ...
                    ai: {
                        ...
                        subtitle: 'Analysis and insights generated by AI',
    ...
    management: {
        ...
        master: {
            fintech: {
                menu: 'Fintech Management',
                title: 'Fintech Management',
                subtitle: 'Asaas Sub-accounts and Identities',
                ...
                noAccountsDesc: 'Start by creating a sub-account to automate your billing and payment splits.',
                accountTypeInternal: 'Internal Unit',
                accountTypeMarketplace: 'Marketplace / External',
                asaasId: 'Asaas ID',
                apiToken: 'API Token',
                quality: 'Quality',
                controlPanel: 'Control Panel',
                automationTitle: 'Receivables Automation',
                automationDesc: 'Now that you can manage sub-accounts, the next step is to configure Rule-Based Payment Splits. Automatically move commissions from the main account to each business unit.',
                splitGuide: 'Split Integration Guide',
                drawerTitle: 'Fintech Identity',
                drawerSubtitle: 'New Asaas Sub-account Setup',
                brandingNameLabel: 'Branding Name (Ex: VERITUM PRO)',
                brandingPlaceholder: 'How it will appear on the invoice',
                notificationEmailLabel: 'Financial Notification Email',
                emailPlaceholder: 'finance@company.com',
                documentLabel: 'Identity CPF/CNPJ',
                unitTypeLabel: 'Unit Type',
                phoneLabel: 'Contact Phone (Optional)',
                phonePlaceholder: '(11) 99999-9999',
                alertTitle: 'This action will create a linked sub-account in Asaas. Make sure the data above is correct for automatic approval.',
                discard: 'Discard',
                syncing: 'Syncing...',
                activate: 'Activate Fintech Identity',
                toast: {
                    fetchError: 'Error loading accounts.',
                    saveSuccess: 'Sub-account created successfully!',
                    saveError: 'Error saving sub-account.'
                }
            },
            cloud: {
                menu: 'Cloud / Add-Ons Management',
                ...
                fetchError: 'Error loading Cloud plans.',
                saveSuccess: 'Plan saved successfully!',
                saveError: 'Error saving plan.',
                rlsError: 'Permission Error: No rows updated (RLS blocked).',
                discountMonthly: 'Monthly Discount (%)',
                discountQuarterly: 'Quarterly Discount (%)',
                discountSemiannual: 'Semiannual Discount (%)',
                discountYearly: 'Yearly Discount (%)'
            },
            gemini: {
                error: 'Configure your Gemini key.'
            },
            vip: {
                menu: 'VIP Club Management',
                title: 'VIP Club Management',
                subtitle: 'Manage benefits and referral rules for the VIP Club program.',
                tabPrizes: 'Prizes Shop',
                tabCoins: 'Coin Factory',
                saving: 'Saving...',
                coinFactoryTitle: 'Referral Rules (Coin Factory)',
                coinFactoryDesc: 'Define how many VIP Points your client earns if the person they referred becomes a subscriber of one of these plans. If the plan does not participate in the promotion, leave everything at ZERO.',
                ...
                tableName: 'Name',
                tableAction: 'Action',
                editBenefit: 'Edit VIP Benefit',
                newBenefit: 'New VIP Benefit',
                createBenefit: 'Create Benefit',
                tabDetails: 'Details',
                tabRules: 'Rules & Costs',
                tabAudience: 'Audience',
                detailsTitle: 'Title',
                detailsShortDesc: 'Short Description (Summary)',
                detailsShortDescPlaceholder: 'Describe the benefit in a few words',
                detailsKey: 'System Key / Slug (Key)',
                detailsKeyPlaceholder: 'ex: discount_next_bill, unlock_module',
                detailsIcon: 'Icon',
                detailsLongDesc: 'Full Description',
                detailsLongDescPlaceholder: 'More information to be detailed in the redemption modal...',
                detailsActive: 'Active for User Redemption',
                rulesMath: 'Mathematical Engine Variables',
                rulesCost: 'Cost in Points',
                rulesCostHint: '(If inherent to the plan, leave zero)',
                rulesDiscount: 'Applied Discount (%) - Optional',
                rulesMetadata: 'Advanced Metadata (Other JSON variables)',
                audienceTitle: 'Benefit Eligibility',
                audienceDesc: 'Link the plans and cycles that entitle to this benefit. If it is not linked to any (standalone sale for the VIP club), just leave everything disabled.',
                audienceCycles: 'Eligible Cycles',
                confirmDeleteTitle: 'Delete Benefit?',
                confirmDeleteMessage: 'Are you sure you want to delete the benefit "{name}"?',
                confirmDeleteNo: 'No',
                confirmDeleteYes: 'Yes, Delete',
                saveSuccess: 'Benefit saved successfully!',
                statusUpdated: 'Status updated',
                statusError: 'Error updating status',
                deleteSuccess: 'Benefit deleted',
                deleteError: 'Error deleting',
                rulesSaved: 'Point earning rules updated successfully!'
            },
            translate: {
                success: 'Success!',
            ...
            persons: {
                ...
                confirmations: {
                    softDeleteTitle: 'Delete Record?',
                    softDeleteMessage: 'Are you sure you want to delete "{name}"? The data can be recovered by the administrator in the future.'
                },
                toasts: {
