    ...
    "management": {
        ...
        "settings": {
            ...
            "plan": {
                ...
                "cancelTitle": "¿Realmente desea cancelar su suscripción?",
                "cancelSubtitle": "Lamentamos verlo partir. Por favor, cuéntenos por qué está cancelando para que podamos mejorar.",
                "cancelReasonLabel": "Motivo de la cancelación",
                "cancelReasonOption1": "Precio demasiado alto",
                "cancelReasonOption2": "Dificultad de uso",
                "cancelReasonOption3": "Falta de funciones necesarias",
                "cancelReasonOption4": "Migrando a otro software",
                "cancelReasonOption5": "Otro motivo",
                "cancelFeedbackPlaceholder": "Cuéntenos un poco más sobre el motivo de la cancelación y cómo podemos mejorar nuestro servicio...",
                "cancelButton": "Confirmar Cancelación",
                "keepPlan": "Mantener Plan",
                "cancelConfirmTitle": "¿Está absolutamente seguro?",
                "cancelConfirmMessage": "Su suscripción se cancelará al final del período actual. Perderá el acceso a las funciones premium.",
                "cancelSuccess": "Su suscripción ha sido cancelada con éxito.",
                "cancelError": "Ocurrió un error ao cancelar su suscripción. Por favor, póngase en contacto con el soporte.",
                "secureOperation": "Operación Segura vía Veritum PRO Cloud"
            }
        },
        "organization": {
            "identification": "Identificación",
        ...
        "master": {
            "fintech": {
                "menu": "Gestión Fintech",
                "title": "Gestión Fintech",
                "subtitle": "Subcuentas e Identidades Asaas",
                "newSubAccount": "Nueva Subcuenta",
                "masterContext": "Contexto Master",
                "selectClientTitle": "Seleccionar Cliente",
                "myContext": "Mi Contexto Master",
                "clientsGroup": "CLIENTES (SOCIOS ADMIN)",
                "noAccounts": "Ninguna subcuenta activa",
                "noAccountsDesc": "Comience creando una subcuenta para automatizar su facturación y splits de pago.",
                ...
                "automationTitle": "Automatización de Cobros",
                "automationDesc": "Ahora que puede gestionar subcuentas, el siguiente paso es configurar el Split de Pago por Reglas. Mueva comisiones de la cuenta principal a cada unidad de negocio automáticamente.",
                "splitGuide": "Guía de Integración de Split",
                "drawerTitle": "Identidad Fintech",
                "drawerSubtitle": "Nueva Configuración de Subcuenta Asaas",
                "brandingNameLabel": "Nombre de la Marca (Ej: VERITUM PRO)",
                "brandingPlaceholder": "Cómo aparecerá en la factura",
                "notificationEmailLabel": "E-mail de Notificación Financiera",
                "emailPlaceholder": "financiero@empresa.com",
                "documentLabel": "DNI/CUIL de la Identidad",
                "unitTypeLabel": "Tipo de Unidad",
                "phoneLabel": "Teléfono de Contacto (Opcional)",
                "phonePlaceholder": "(11) 99999-9999",
                "alertTitle": "Esta acción creará una subcuenta vinculada en Asaas. Asegúrese de que los datos anteriores sean correctos para la aprobación automática.",
                "discard": "Descartar",
                "syncing": "Sincronizando...",
                "activate": "Activar Identidad Fintech",
                "toast": {
                    "fetchError": "Error al cargar cuentas.",
                    "saveSuccess": "¡Subcuenta creada con éxito!",
                    "saveError": "Error al guardar subcuenta."
                }
            },
            "cloud": {
                "menu": "Gestión de Cloud / Add-Ons",
                ...
                "fetchError": "Error al cargar planes de Cloud.",
                "saveSuccess": "¡Plan guardado con éxito!",
                "saveError": "Error al guardar plan.",
                "rlsError": "Error de Permiso: Ninguna fila actualizada (RLS bloqueó).",
                "discountMonthly": "Descuento Mensal (%)",
                "discountQuarterly": "Descuento Trimestral (%)",
                "discountSemiannual": "Descuento Semestral (%)",
                "discountYearly": "Descuento Anual (%)"
            },
            "gemini": {
                "error": "Configure su clave de Gemini."
            },
            "vip": {
                "menu": "Gestión Club VIP",
                "title": "Gestión Club VIP",
                "subtitle": "Gestione los beneficios y las reglas de recomendación del programa Club VIP.",
                "tabPrizes": "Tienda de Premios",
                "tabCoins": "Fábrica de Monedas",
                "saving": "Guardando...",
                "coinFactoryTitle": "Reglas de Recomendación (Fábrica de Monedas)",
                "coinFactoryDesc": "Defina cuántos Puntos VIP gana su cliente si la persona que recomendó se convierte en suscriptor de uno de estos planes. Si el plan no participa en la promoción, deje todo en CERO.",
                ...
                "tableName": "Nombre",
                "tableAction": "Acción",
                "editBenefit": "Editar Beneficio VIP",
                "newBenefit": "Nuevo Beneficio VIP",
                "createBenefit": "Crear Beneficio",
                "tabDetails": "Detalles",
                "tabRules": "Reglas y Costos",
                "tabAudience": "Público",
                "detailsTitle": "Título",
                "detailsShortDesc": "Descripción Corta (Resumen)",
                "detailsShortDescPlaceholder": "Describa el beneficio en pocas palabras",
                "detailsKey": "Key del Sistema / Slug (Clave)",
                "detailsKeyPlaceholder": "ej: descuento_proxima_factura, liberar_modulo",
                "detailsIcon": "Ícono",
                "detailsLongDesc": "Descripción Completa",
                "detailsLongDescPlaceholder": "Más información a ser detallada en el modal de canje...",
                "detailsActive": "Activo para Canje del Usuario",
                "rulesMath": "Variables del Motor Matemático",
                "rulesCost": "Costo en Puntos",
                "rulesCostHint": "(Si es inherente al plan, deje cero)",
                "rulesDiscount": "Descuento Aplicado (%) - Opcional",
                "rulesMetadata": "Metadata Avanzada (Otras variables JSON)",
                "audienceTitle": "Elegibilidad del Beneficio",
                "audienceDesc": "Vincule los planes y ciclos que dan derecho a este beneficio. Si no está vinculado a ninguno (venta individual para el club vip), simplemente deje todo desactivado.",
                "audienceCycles": "Ciclos Elegibles",
                "confirmDeleteTitle": "¿Eliminar Beneficio?",
                "confirmDeleteMessage": "¿Está seguro que desea eliminar el beneficio \"{name}\"?",
                "confirmDeleteNo": "No",
                "confirmDeleteYes": "Sí, Eliminar",
                "saveSuccess": "¡Beneficio guardado con éxito!",
                "statusUpdated": "Estado actualizado",
                "statusError": "Error al actualizar estado",
                "deleteSuccess": "Beneficio eliminado",
                "deleteError": "Error al eliminar",
                "rulesSaved": "¡Reglas de obtención de puntos actualizadas con éxito!"
            },
            "translate": {
                "success": "¡Éxito!",
            ...
            "plans": {
                ...
                "form": {
                    ...
                    "monthlyPrice": "Precio Mensual Base (R$)",
                    "discount": "% Mensual",
            ...
            "persons": {
                ...
                "stats": {
                    ...
                    "activeLawsuits": "Procesos Activos"
                },
                "table": {
                    "member": "Miembro",
                ...
                "confirmations": {
                    "softDeleteTitle": "¿Eliminar Registro?",
                    "softDeleteMessage": "¿Está seguro de que desea eliminar a \"{name}\"? El dato podrá ser recuperado por el administrador en el futuro."
                },
                "toasts": {
