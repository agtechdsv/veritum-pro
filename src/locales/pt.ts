export const pt = {
    ...
    management: {
        features: {
            cognitio_dashboards: 'Dashboards Analíticos',
            cognitio_magistrados: 'Perfil de Magistrados',
            cognitio_preditiva: 'Análise Preditiva (IA)',
            intelligence_golden_alerts: 'Golden Alerts',
            intelligence_matcher: 'Semantic Matcher',
            nexus_controle_societario: 'Controle Societário',
            nexus_gestao_ativos: 'Gestão de Ativos e Bens',
            nexus_gestao_equipe: 'Gestão de Equipe e Workspace',
            nexus_gestao_pessoas: 'Gestão de Pessoas (CRM Básico)',
            nexus_gestao_prazos: 'Gestão de Processos e Prazos',
            nexus_workflows: 'Workflows Avançados',
            scriptor_assinatura: 'Assinatura Digital',
            scriptor_auditoria_risco: 'Auditoria de Risco (IA)',
            scriptor_ged: 'Repositório de Documentos (GED)',
            scriptor_gerador_ia: 'Gerador de Peças (IA)',
            sentinel_analise_sentimento: 'Análise de Sentimento (IA)',
            sentinel_captura_antecipada: 'Captura Antecipada',
            sentinel_clipping_midia: 'Clipping Inteligente',
            sentinel_diarios: 'Monitoramento de Diários',
            valorem_boletos_pix: 'Emissão de Boletos e PIX',
            valorem_financeiro: 'Gestão Financeira',
            valorem_pjecalc: 'Integração PJe-Calc e Atualizações',
            valorem_provisionamento: 'Relatórios de Contingência',
            vox_portal: 'Portal do Cliente',
            vox_traducao_ia: 'Tradução de Juridiquês (IA)',
            vox_whatsapp: 'Automação de WhatsApp'
        },
        accessGroups: {
