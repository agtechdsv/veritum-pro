        ...
        <div className="flex flex-col h-full space-y-6">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    <div className="bg-amber-600 text-white p-3 rounded-xl shadow-lg shadow-amber-200 dark:shadow-amber-900/40">
                        <FileText size={24} />
                    </div>
                    <div>
                        <h1 className="text-2xl font-bold text-slate-800 dark:text-white transition-colors text-gradient">Redação Scriptor</h1>
                        <p className="text-sm text-slate-500 dark:text-slate-400 font-medium">Geração de minutas e documentos com Inteligência Artificial</p>
                    </div>
                </div>
