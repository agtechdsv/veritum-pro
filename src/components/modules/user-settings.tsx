        ...
        <div className="max-w-4xl mx-auto space-y-10 pb-12 animate-in fade-in duration-500">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    ...
                    <p className="text-slate-500 dark:text-slate-400 font-medium tracking-tight uppercase text-xs">Ajustes globais do seu workspace.</p>
                </div>
                ...
                {isRootAdmin && (
                    <div className="flex bg-slate-100 dark:bg-slate-900 p-1.5 rounded-2xl border border-slate-200 dark:border-slate-800">
                        ...
                        >
                            <Building2 size={14} /> Dados do Escritório
                        </button>
                    </div>
                )}
            </div>
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        <div className="space-y-4">
                                            <div>
                                                <label className="block text-[10px] font-black text-indigo-300 uppercase tracking-widest mb-2">Custom Supabase URL</label>
                                            ...
                                            <div>
                                                <label className="block text-[10px] font-black text-indigo-300 uppercase tracking-widest mb-2">Custom Supabase Key</label>
                                                <div className="relative">
                                        ...
                                        <div className="space-y-4">
                                            <div>
                                                <label className="block text-[10px] font-black text-indigo-300 uppercase tracking-widest mb-2">Custom Gemini Key</label>
                                                <div className="relative">
                                            ...
                                            <div className="p-6 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-sm">
                                                <p className="text-sm text-indigo-100 leading-relaxed font-bold">
                                                    ...
                                                    Ao utilizar BYODB, seus dados de clientes, processos e faturamento nunca saem do seu próprio servidor Supabase.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
